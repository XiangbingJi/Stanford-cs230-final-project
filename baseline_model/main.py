...
tf.app.flags.DEFINE_string('testing', "log/model.ckpt-0", """ checkpoint file """)
...
tf.app.flags.DEFINE_string('image_dir', "dataset/train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', "dataset/test.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "dataset/val.txt", """ path to CamVid val image """)
