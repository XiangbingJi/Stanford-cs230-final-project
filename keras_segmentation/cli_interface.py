...
def cli_train():
    ...
    parser.add_argument('--not_verify_dataset', action='store_false', default=True)
...
def cli_predict():
    ...
    if ".jpg" in args.input_path or ".png" in args.input_path or ".jpeg" in args.input_path:
        ...
        predict.predict_multiple(inp_dir=args.input_path, out_dir=args.output_path,
                                 checkpoints_path=args.checkpoints_path)
...
def cli_evaluate():
    ...
    assert args.annots_dir is not None
    assert args.checkpoints_path is not None

    predict.evaluate(images_dir=args.images_dir, annots_dir=args.annots_dir, checkpoints_path=args.checkpoints_path)
